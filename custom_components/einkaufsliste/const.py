...
CONF_ONLY_CHECKED = "only_checked"

DEFAULT_OPTIONS = {
    CONF_CLEANUP_WEEKDAY: 6,
    CONF_CLEANUP_TIME: "03:00:00",
    CONF_MIN_AGE_DAYS: 7,
    CONF_ONLY_CHECKED: False,
}
...
HISTORY_LIMIT = 400
# Wird ein Artikel innerhalb dieser Zeit wieder "enthakt", gilt es als Versehen:
# Name und Datum bleiben dann wie vorher.
